...
if ( ! function_exists( 'woodmart_show_sidebar_btn' ) ) {
	...
	function woodmart_show_sidebar_btn() {
		...
		?>
			<div class="wd-show-sidebar-btn wd-action-btn wd-style-text<?php echo woodmart_get_old_classes( ' woodmart-show-sidebar-btn' ); ?>">
...
if ( ! function_exists( 'woodmart_products_view_select' ) ) {
	function woodmart_products_view_select( $is_element = false ) {
		...
		<div class="wd-products-shop-view<?php echo woodmart_get_old_classes( ' woodmart-products-shop-view' ); ?> <?php echo esc_attr( 'products-view-' . $shop_view ); ?>">
			...
			<a rel="nofollow noopener" href="<?php echo esc_url( $link ); ?>" class="shop-view per-row-list<?php echo esc_attr( $classes ); ?>" aria-label="<?php esc_attr_e( 'List view', 'woodmart' ); ?>">
			...
			<?php if ( $per_row_selector && $per_row_options ) : ?>
				<?php foreach ( $products_per_row_options as $key => $value ) : ?>
					...
					<a rel="nofollow noopener" href="<?php echo esc_url( $link ); ?>" class="shop-view<?php echo esc_attr( $classes ); ?>" aria-label="<?php echo esc_attr( sprintf( __( 'Grid view %s', 'woodmart' ), $value ) ); ?>">
...
if ( ! function_exists( 'woodmart_product_categories_nav' ) ) {
	function woodmart_product_categories_nav() {
		...
		echo '<ul class="wd-nav-product-cat wd-nav wd-gap-m wd-style-underline ' . esc_attr( $class ) . '">';
...
if ( ! function_exists( 'woodmart_topbar_links' ) ) {
	function woodmart_topbar_links( $items = '', $args = array(), $return = false ) {
		...
		if ( $is_mobile_menu || $return ) {
			...
			if ( $is_wishlist_in_header && $is_mobile_menu && ( ! woodmart_get_opt( 'wishlist_logged' ) || ( woodmart_get_opt( 'wishlist_logged' ) && is_user_logged_in() ) ) ) {

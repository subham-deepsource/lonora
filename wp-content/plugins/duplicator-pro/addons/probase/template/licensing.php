...
if ($license_status == License::STATUS_VALID) {
    ...
    $license_status_text  = ($global->license_no_activations_left) ?
        __(
            ...
            '<br/> Please use the link above to login to your snapcreek.com dashboard to manage your licenses.',
            'duplicator-pro'
        ) :
    ...
    <table class="form-table">
        <tr valign="top">
            ...
            <td>
                <?php
                echo sprintf(
                    DUP_PRO_U::__('%1$sManage/Upgrade Licenses%2$s'),
                    '<a target="_blank" href="https://snapcreek.com/dashboard">',
                    '</a>'
                );
                ?>
            </td>
            ...
            <td class="dpro-license-type">
                ...
                switch ($license) {
                    case License::TYPE_PERSONAL:
                        ...
                        LicensingController::typeViewer(array('mu2' => 0, 'lic' => $global->license_limit));
                        break;
                    ...
                    case License::TYPE_BUSINESS_GOLD:
                        ...
                        LicensingController::typeViewer(array('mu2' => 1, 'lic' => DUP_PRO_U::__('Unlimited*')));
                        break;
                    default:
